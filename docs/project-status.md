...
1. **PR H3: CI**
   - Add local validation to GitHub Actions.

2. **PR H4: Release packaging**
...
- No CI exists yet; validation is currently local only, with root `Makefile` targets for repeatable local checks.
