...
1. **PR G3: Audit log**
   - Add task audit events and input/output metadata.
   - Keep audit records free of raw skill text, prompts, tokens, and secrets.
