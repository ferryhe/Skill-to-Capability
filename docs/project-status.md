...
1. **PR F1: MCP server skeleton**
   - Bootstrap the TypeScript MCP adapter package.
   - Add a Gateway client and config/env handling.
   - Keep list/run tool implementation for the follow-up F2 scope.
